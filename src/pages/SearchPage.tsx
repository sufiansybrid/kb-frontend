...
import { formatDateTime, highlightMatch, getErrorMessage } from '../utils/helpers';
...
export function SearchPage() {
  ...
  // Auto-search if q param is set on mount
  useEffect(() => {
      ...
      <div className="card">
        <div className="p-4">
          <form onSubmit={handleSubmit} className="flex gap-2 flex-wrap">
            ...
            <button type="submit" className="btn-primary btn" disabled={loading || !query.trim()}>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex flex-wrap gap-3 text-[11px] text-gray-400 mb-2">
                        {r.source_url && (
                          <a href={r.source_url} target="_blank" rel="noreferrer" className="text-brand hover:underline truncate max-w-xs">
                            {r.source_url}
                          </a>
                        )}
                      ...
                      {r.snippet && (
                        <p
                          ...
                          dangerouslySetInnerHTML={{ __html: highlightMatch(r.snippet, displayQuery) }}
                        />
                      )}
                    </div>
                  </div>
